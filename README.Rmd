...
> Choose one species of your choice and fit the same linear model to the data for that species only. What is the slope? What is the correlation coefficient? Create a graph with scatterplot and linear regression line.
